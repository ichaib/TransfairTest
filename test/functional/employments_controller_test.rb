...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { job: @employment.job, rating_servicepartner: @employment.rating_servicepartner, service_partner_id: @employment.service_partner_id }
    end
  ...
  test "should update employment" do
    put :update, id: @employment, employment: { job: @employment.job, rating_servicepartner: @employment.rating_servicepartner, service_partner_id: @employment.service_partner_id }
    assert_redirected_to employment_path(assigns(:employment))
  end
